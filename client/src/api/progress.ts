...
export async function updateProgress(payload: ProgressPayload): Promise<ProgressResponse> {
    const token = localStorage.getItem('token');
    const response = await api.post<ProgressResponse>('/api/progress/update/', payload, {
        headers: {
